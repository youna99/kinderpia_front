...
// 타입 호출
import { MeetingDetailData, UpdateMeetingFormData } from '../../types/meeting';
  ...
  return (
    <section className="meeting-update-page">
      <span className="meeting-update-page-notice">
        <i className="xi-check"></i> 표시만 수정 가능합니다.
      </span>
      ...
      <form className="meeting-update-page-form">
        ...
        <CategoryInput value={categoryId} disabled={true} isRequired={false} />
        ...
        <div className="join-method-container">
          <div className="join-method-header">
            <label className="join-method-header-title">신청 방식</label>
          </div>
          <hr />
